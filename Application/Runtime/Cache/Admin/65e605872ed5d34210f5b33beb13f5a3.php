...
<head>
	...
	<link rel="stylesheet" href="/thinkcms/Application/Admin/View/Resource/css/bootstrap-3.3.5.min.css" />
	<link rel="stylesheet" href="/thinkcms/Application/Admin/View/Resource/css/header.css" />
	<title>CMS信息发布系统登录</title>
</head>
<body>
	<!--
		...
		<nav class="nav navbar-default navbar-fixed-top" role="navigation">
			<div class="container-fluid">
				<div class="navbar-header">
					...
					<a class="navbar-brand">***管理系系统</a>
				</div>
				<div class="collapse navbar-collapse" id="header-collapse">
					<ul class=" nav navbar-nav mynavbar navbar-right">
						<li><a>欢迎您!&nbsp;&nbsp;<span>Admin</span></a></li>
						<li><a>首页</a></li>
						<li><a>退出</a></li>
					</ul>
				</div>				
							...
							<div class="row">
							  <div class="col-xs-6 col-md-3">
							    <a href="#" class="thumbnail">
							      <img src="/thinkcms/Application/Admin/View/Resource/images/xsphp_f.png" alt="细说PHP">
							    </a>
							  </div>
							  <div class="col-xs-6 col-md-3">
							    <a href="#" class="thumbnail">
								...
								<div class="table-responsive">
									<table class="table">
										...
										<tbody>
											<tr>
												<td>服务器环境：</td>
												<td>WINNT&nbsp;|&nbsp;Apache/2.4.17(win32)&nbsp;OpenSSL/1.0.2d&nbsp;PHP/5.6.23</td>
											</tr>
											<tr>
												<td>域名：</td>
												<td>localhost</td>
									...
									<form role="form">
									    <div class="form-horizontal">
									    	...
									    	<div class="form-group">
									    		...
									    		<div class="col-sm-2">
												   <div class="thumbnail">
												    	<img src="../Resource/images/xsphp_f.png" alt="细说PHP">	
												    </div>	
												</div>
	...
	<script type="text/javascript" src="/thinkcms/Application/Admin/View/Resource/js/jquery-2.1.4.min.js" ></script>
	<script type="text/javascript" src="/thinkcms/Application/Admin/View/Resource/js/bootstrap-3.3.5.min.js" ></script>
	<script type="text/javascript" src="/thinkcms/Application/Admin/View/Resource/ckeditor_4.5.11_full/ckeditor.js" ></script>
