		...
		<nav class="nav navbar-default navbar-fixed-top" role="navigation">
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="header-collapse">
					<ul class="nav nav-tabs navbar-nav mynavbar navbar-right">
						<li>
							...
							<ul class="dropdown-menu" role="menu">
						        <li>
						            <a href="#" class="text-center">个人信息</a>
						        </li>
						        <li>
						            <a href="#" class="text-center">切换帐号</a>
						        </li>						        
						        <li>
						            <a href="/thinkcms/admin.php/Login/userLogout" class="text-center">退出</a>
						        </li>
						    </ul>
						</li>
						<li>
						...
						<li>
							...
							<ul class="dropdown-menu" role="menu">
						        <li>
						            <a href="#" class="text-center">默认(黑色)</a>
						        </li>
						        <li>
						            <a href="#" class="text-center">蓝色</a>
						        </li>						        
						        <li>
						            <a href="#" class="text-center">黄色</a>
						        </li>
						    </ul>
	...
	<section>
		<div class="container-fluid">
			<div class="row">
						...
						<ul class="nav nav-tabs nav-stacked firstmenu">
								<li class="li_tabs">					
									...
									<ul id="commonManager" class="nav nav-list collapse secondmenu" style="height: 0px;">
		                            	<li class="li_systemInfo"><a href="#systemInfo" data-toggle="tab"><i class="glyphicon glyphicon-user"></i>&nbsp;系统信息</a></li>
				...
				<div class="col-md-9" >
					<div class="tab-content scrollable-y">									<div id="systemManager" class="tab-pane active">
							<!--带标题面板 -->
